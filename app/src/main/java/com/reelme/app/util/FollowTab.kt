...
class FollowTab(internal var context: Context, attrs: AttributeSet) : TabLayout(context, attrs) {
    ...
    override fun setupWithViewPager(viewPager: ViewPager?) {
        ...
        val tabs = context.resources.getStringArray(R.array.tabs_follow)
    ...
    private fun addTabs(tabName: String, i: Int) {
        val tabOne = LayoutInflater.from(getContext()).inflate(R.layout.follow_tab, null) as LinearLayout
