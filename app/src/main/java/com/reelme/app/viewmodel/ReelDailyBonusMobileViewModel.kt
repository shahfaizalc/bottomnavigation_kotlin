...
class ReelDailyBonusMobileViewModel(private val context: Context, private val fragmentSignin: FragmentReelDailyBonus) : BaseObservable(), NetworkChangeHandler.NetworkChangeListener {
