...
class ReelTypeMobileViewModel(private val context: Context, private val fragmentSignin: FragmentReelType4) : BaseObservable(), NetworkChangeHandler.NetworkChangeListener {
