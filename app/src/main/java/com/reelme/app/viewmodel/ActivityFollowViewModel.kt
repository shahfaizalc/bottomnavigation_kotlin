...
class ActivityFollowViewModel(private val fragmentSignin: FragmentFollow) : BaseObservable() {
    ...
    private fun showToast(id: Int) {
        Toast.makeText(fragmentSignin.context, fragmentSignin.resources.getString(id),
                Toast.LENGTH_LONG).apply {setGravity(Gravity.TOP, 0, 0); show() }
    }
