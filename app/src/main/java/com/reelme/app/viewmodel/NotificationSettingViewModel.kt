...
class NotificationSettingViewModel(private val context: Context, private val fragmentSignin: FragmentNotificationSetting) : BaseObservable(), NetworkChangeHandler.NetworkChangeListener {
