...
class UserProfileViewModel(private val context: Context, private val fragmentSignin: FragmentUserProfile) : BaseObservable(), NetworkChangeHandler.NetworkChangeListener {
