...
import com.reelme.app.databinding.ListItemAdventureBinding
...
import com.reelme.app.listeners.ChooseYourAdventureEventListener
...
import com.reelme.app.viewmodel.ChooseYourAdventuresModel
 ...
 */
class ChooseYourAdventureAdapter(private val adSearchModel: ChooseYourAdventuresModel) :
        ChooseYourAdventureEventListener, RecyclerView.Adapter<ChooseYourAdventureAdapter.ViewHolder>(){
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, i: Int)
            = ViewHolder(LayoutInflater.from(viewGroup.context).inflate(R.layout.list_item_adventure,
            viewGroup, false))
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        var binding: ListItemAdventureBinding? = null
    ...
    override fun onClickAdSearchListItem(countriesViewModel: ChooseYourAdventuresModel, position: Int) {
