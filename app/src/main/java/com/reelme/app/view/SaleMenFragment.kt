...
class SaleMenFragment : BaseFragment(), NetworkChangeHandler.NetworkChangeListener {
    ...
    private fun doRequest() {
        ...
        binding!!.mainData!!.getAllSalesList(RequestType.MEN).observe(this,object :Observer<List<Sale>>{
