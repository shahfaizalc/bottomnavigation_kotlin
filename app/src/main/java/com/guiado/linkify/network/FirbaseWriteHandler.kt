package com.guiado.linkify.network
...
import com.guiado.linkify.utils.Constants.BASEURL_COLLECTION_GEN_DISCUSSION
import com.guiado.linkify.utils.Constants.BASEURL_COLLECTION_GEN_FEEDBACK
import com.guiado.linkify.utils.Constants.BASEURL_COLLECTION_GEN_GROUPS
import com.guiado.linkify.utils.Constants.BASEURL_COLLECTION_GEN_POSTEVVENT
import com.guiado.linkify.utils.Constants.BASEURL_COLLECTION_GEN_PROFILEINFO
import com.guiado.linkify.utils.Constants.BASEURL_COLLECTION_GEN_REVIEW
import com.guiado.linkify.utils.Constants.BASEURL_COLLECTION_PROFILEPIC
...
//    }
    ...
    fun updateLikes(userInfo: ImageEvents, emptyResultListener: EmptyResultListener) {
        val myDB = FirebaseFirestore.getInstance()
        val collection = myDB.collection(BASEURL_COLLECTION_GEN_POSTEVVENT_IMG)
        collection.document(userInfo.postedDate!!).set(userInfo)
                .addOnSuccessListener {
