...
import com.guiado.akbhar.adapter.PoliticsAdapter
 ...
 */
class RecyclerLoadMorePoliticsHandler(private val countriesViewModel: PoliticsViewModel,
                                      private val listViewAdapter: PoliticsAdapter) {
