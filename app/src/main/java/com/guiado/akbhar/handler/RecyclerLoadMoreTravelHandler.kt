...
import com.guiado.akbhar.adapter.TravelAdapter
 ...
 */
class RecyclerLoadMoreTravelHandler(private val countriesViewModel: TravelViewModel,
                                    private val listViewAdapter: TravelAdapter) {
