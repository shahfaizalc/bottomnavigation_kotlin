...
import com.guiado.akbhar.adapter.BusinessAdapter
 ...
 */
class RecyclerLoadMoreBusinessHandler(private val countriesViewModel: BusinessViewModel,
                                      private val listViewAdapter: BusinessAdapter) {
