...
import com.guiado.akbhar.adapter.SportsAdapter
 ...
 */
class RecyclerLoadMoreSportsHandler(private val countriesViewModel: SportsViewModel,
                                    private val listViewAdapter: SportsAdapter) {
