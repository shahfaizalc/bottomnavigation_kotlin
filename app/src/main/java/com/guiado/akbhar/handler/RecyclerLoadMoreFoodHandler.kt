...
import com.guiado.akbhar.adapter.FoodAdapter
 ...
 */
class RecyclerLoadMoreFoodHandler(private val countriesViewModel: FoodViewModel,
                                  private val listViewAdapter: FoodAdapter) {
