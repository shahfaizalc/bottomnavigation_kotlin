...
import com.guiado.akbhar.adapter.ArtAdapter
 ...
 */
class RecyclerLoadMoreArtHandler(private val countriesViewModel: ArtViewModel,
                                 private val listViewAdapter: ArtAdapter) {
