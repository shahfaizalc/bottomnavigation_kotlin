...
import com.guiado.akbhar.adapter.ScienceAdapter
 ...
 */
class RecyclerLoadMoreScienceHandler(private val countriesViewModel: ScienceViewModel,
                                     private val listViewAdapter: ScienceAdapter) {
