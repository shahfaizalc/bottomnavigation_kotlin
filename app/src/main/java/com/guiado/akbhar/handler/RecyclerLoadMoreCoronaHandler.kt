...
import com.guiado.akbhar.adapter.CoronaAdapter
 ...
 */
class RecyclerLoadMoreCoronaHandler(private val countriesViewModel: CoronaModel,
                                    private val listViewAdapter: CoronaAdapter) {
