...
class TechViewModel (internal var activity: Activity,
    ...
    init {
        ...
        query = db.collection("/NEWS/news_arabic/world").whereEqualTo(LANGUAGE_ID, pref).whereEqualTo("newstype", NewsTypeEnum.TECHNOLOGY).orderBy("growZoneNumber", Query.Direction.DESCENDING).limit(10)
        doGetTalents()
    }
