...
import com.guiado.akbhar.view.FragmentEntertainement
import com.guiado.akbhar.view.WebViewActivity


class EntertainementViewModel (internal var activity: FragmentActivity,
                               internal val fragmentProfileInfo: FragmentEntertainement) // To show list of user images (Gallery)
    : BaseObservable() {
    ...
    init {
        ...
        query = db.collection("/NEWS/news_arabic/world").whereEqualTo("newstype", NewsTypeEnum.ENTERTAINMENT).orderBy("growZoneNumber", Query.Direction.DESCENDING).limit(10)
        doGetTalents()
    }
