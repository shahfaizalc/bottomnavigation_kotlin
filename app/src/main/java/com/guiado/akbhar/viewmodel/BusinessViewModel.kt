...
class BusinessViewModel (internal var activity: FragmentActivity,
                         internal val fragmentProfileInfo: FragmentBusiness) // To show list of user images (Gallery)
    : BaseObservable() {
    ...
    init {
        ...
        query = db.collection("/NEWS/news_arabic/business").orderBy("growZoneNumber", Query.Direction.DESCENDING).limit(10)
        doGetTalents()
    }
