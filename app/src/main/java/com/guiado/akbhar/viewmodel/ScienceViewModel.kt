...
class ScienceViewModel (internal var activity: FragmentActivity,
    ...
    init {
        ...
        query = db.collection("/NEWS/news_arabic/science").orderBy("growZoneNumber", Query.Direction.DESCENDING).limit(10)
        doGetTalents()
    }
