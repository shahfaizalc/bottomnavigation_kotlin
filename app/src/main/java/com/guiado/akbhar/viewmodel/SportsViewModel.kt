...
class SportsViewModel (internal var activity: FragmentActivity,
                       internal val fragmentProfileInfo: FragmentSports) // To show list of user images (Gallery)
    : BaseObservable() {
    ...
    init {
        ...
        query = db.collection("/NEWS/news_arabic/sports").orderBy("growZoneNumber", Query.Direction.DESCENDING).limit(10)
        doGetTalents()
    }
