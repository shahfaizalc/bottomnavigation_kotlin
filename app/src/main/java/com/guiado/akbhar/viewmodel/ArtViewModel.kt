...
import com.guiado.akbhar.view.FragmentArt
import com.guiado.akbhar.view.WebViewActivity


class ArtViewModel (internal var activity: Activity,
                    internal val fragmentProfileInfo: FragmentArt) // To show list of user images (Gallery)
    : BaseObservable() {
    ...
    init {
        ...
        query = db.collection("/NEWS/news_arabic/world").whereEqualTo("newstype", NewsTypeEnum.ART).orderBy("growZoneNumber", Query.Direction.DESCENDING).limit(10)
        doGetTalents()
    }
