...
class ArtViewModel (internal var activity: FragmentActivity,
    ...
    init {
        ...
        query = db.collection("/NEWS/news_arabic/art").orderBy("growZoneNumber", Query.Direction.DESCENDING).limit(10)
        doGetTalents()
    }
