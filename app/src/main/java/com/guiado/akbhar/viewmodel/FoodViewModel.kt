...
class FoodViewModel (internal var activity: FragmentActivity,
    ...
    init {
        ...
        query = db.collection("/NEWS/news_arabic/food").orderBy("growZoneNumber", Query.Direction.DESCENDING).limit(10)
        doGetTalents()
    }
