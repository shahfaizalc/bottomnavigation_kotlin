...
class GameViewModel (internal var activity: FragmentActivity,
    ...
    init {
        ...
        query = db.collection("/NEWS/news_arabic/game").orderBy("growZoneNumber", Query.Direction.DESCENDING).limit(10)
        doGetTalents()
    }
