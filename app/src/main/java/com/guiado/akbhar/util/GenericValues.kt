...
import com.guiado.akbhar.utils.Constants.FILENAME_CATEGORY
import com.guiado.akbhar.utils.Constants.FILENAME_SINGLE_CHOICE_ATTR
...
class GenericValues {
    ...
    fun discussionToString(profile : Feed) : String{
        val gson  = Gson();
        return gson.toJson(profile)
    }
    ...
    fun getDisccussion2(fileName: String,context: Context): Feed {
        val gson = Gson()
        return gson.fromJson(fileName, Feed::class.java)
    }
