...
import com.guiado.akbhar.databinding.ListItemGameBinding
import com.guiado.akbhar.listeners.DiscussionEventListener
import com.guiado.akbhar.listeners.GameEventListener
 ...
 */
class GameAdapter(private val adSearchModel: GameViewModel) :
        GameEventListener, RecyclerView.Adapter<GameAdapter.ViewHolder>(){
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, i: Int)
            = ViewHolder(LayoutInflater.from(viewGroup.context).inflate(R.layout.list_item_game,
            viewGroup, false))
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        var binding: ListItemGameBinding? = null
    ...
    override fun onClickAdSearchListItem(countriesViewModel: GameViewModel, position: Int) {
