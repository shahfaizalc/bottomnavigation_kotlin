...
import com.guiado.akbhar.databinding.ListItemMoroccoBindingImpl
 ...
 */
class MoroccoAdapter(private val adSearchModel: MoroccoViewModel) :
        MoroccoEventListener, RecyclerView.Adapter<MoroccoAdapter.ViewHolder>(){
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, i: Int)
            = ViewHolder(LayoutInflater.from(viewGroup.context).inflate(R.layout.list_item_morocco,
            viewGroup, false))
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        var binding: ListItemMoroccoBinding? = null
