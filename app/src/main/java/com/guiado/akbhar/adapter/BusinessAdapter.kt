...
import com.guiado.akbhar.databinding.ListItemBusinessBinding
import com.guiado.akbhar.databinding.ListItemDiscussionBinding
import com.guiado.akbhar.listeners.BusinessEventListener
 ...
 */
class BusinessAdapter(private val adSearchModel: BusinessViewModel) :
        BusinessEventListener, RecyclerView.Adapter<BusinessAdapter.ViewHolder>(){
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, i: Int)
            = ViewHolder(LayoutInflater.from(viewGroup.context).inflate(R.layout.list_item_business,
            viewGroup, false))
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        var binding: ListItemBusinessBinding? = null
    ...
    override fun onClickAdSearchListItem(countriesViewModel: BusinessViewModel, position: Int) {
