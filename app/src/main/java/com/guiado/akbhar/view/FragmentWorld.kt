...
import com.guiado.akbhar.databinding.ContentWorldBinding
...
class  FragmentWorld : BaseFragment() {
    ...
    private fun bindView(inflater: LayoutInflater, container: ViewGroup?): View {
        if (binding == null) {
            binding = DataBindingUtil.inflate<ContentWorldBinding>(inflater, R.layout.content_world, container, false)
            val areaViewModel = WorldViewModel(activity!!, this)
