...
import com.faizal.guiado.adapter.EventsListAdapter
import com.faizal.guiado.utils.EndlessRecyclerViewScrollListener
 ...
 */
class RecyclerLoadMoreEventsHandler(private val countriesViewModel: AdSearchModel,
                                    private val listViewAdapter: EventsListAdapter) {
