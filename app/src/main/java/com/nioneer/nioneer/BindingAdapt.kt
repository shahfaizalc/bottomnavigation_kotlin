...
import com.nioneer.nioneer.handler.*
import com.nioneer.nioneer.model.BlogItemModel
import com.nioneer.nioneer.model.CoachItem
import com.nioneer.nioneer.model.CountriesInfoModel
import com.nioneer.nioneer.model.SearchMode
import com.nioneer.nioneer.model2.PostDiscussion
import com.nioneer.nioneer.handlers.RecyclerLoadItemsBlogHandler
...
fun adapter(searchView: SearchView, rssHomeViewModel: RssHomeViewModel, recyclerView: RecyclerView) {
    ...
    recyclerView.adapter = listAdapter
    bindingAdapter.scrollListener(recyclerView, linearLayoutManager)
    bindingAdapter.initRequest(recyclerView, Constantss.PATH_FEED)
