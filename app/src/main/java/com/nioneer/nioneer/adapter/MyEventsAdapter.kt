...
import com.nioneer.nioneer.databinding.ListItemMyeventsBinding
import com.nioneer.nioneer.listeners.*
import com.nioneer.nioneer.util.convertLongToTime
import com.nioneer.nioneer.util.getDiscussionCategories
import com.nioneer.nioneer.viewmodel.*

/**
 * Country recycler view adapter to view list of items
 */
class MyEventsAdapter(private val adSearchModel: MyEventsModel) :
        MyEventsEventListener, RecyclerView.Adapter<MyEventsAdapter.ViewHolder>(){
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, i: Int)
            = ViewHolder(LayoutInflater.from(viewGroup.context).inflate(R.layout.list_item_myevents,
            viewGroup, false))
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        var binding: ListItemMyeventsBinding? = null
    ...
    override fun onClickAdSearchListItem(countriesViewModel: MyEventsModel, position: Int) {
