...
import com.nioneer.nioneer.utils.FragmentHistory
import com.nioneer.nioneer.utils.Utils
import com.nioneer.nioneer.view.*
import com.nioneer.nioneer.views.FragNavController
...
class Main2Activity : BaseActivity(), BaseFragment.FragmentNavigation,
    ...
    override fun getRootFragment(index: Int): Fragment {
        when (index) {
            ...
            FragNavController.TAB1 -> return RssHomeActivity()
            FragNavController.TAB2 -> return FragmentMyGroups()
            FragNavController.TAB3 -> return FragmentDiscussions()
            FragNavController.TAB4 -> return FragmentPostAdPricing()
        }
